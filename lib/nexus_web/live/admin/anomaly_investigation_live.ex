            ...
            <div class="space-y-6">
              ...
              <div class="grid grid-cols-2 gap-4">
                <div class="p-4 bg-slate-900/50 rounded-xl border border-white/5">
                  <label class="block text-[10px] font-bold text-slate-500 uppercase tracking-widest mb-1">Organization</label>
            ...
            <div class="p-8 flex-1">
              ...
              <% else %>
                <div class="flex flex-col items-center justify-center py-20 text-center space-y-4 opacity-50 h-full">
                  ...
                  <p class="text-sm text-slate-500 uppercase tracking-widest font-bold">No Source Invoice Linked</p>
                  <p class="text-xs text-slate-600 max-w-[240px]">This anomaly was detected via an external data stream (e.g., API webhook) without a primary invoice reference.</p>
                </div>
              <% end %>
            </div>
          </.dark_card>
