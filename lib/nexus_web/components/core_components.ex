defmodule NexusWeb.CoreComponents do
  ...
  def modal(assigns) do
    ...
    >
      <div id={"#{@id}-bg"} class="bg-black/60 backdrop-blur-sm fixed inset-0 transition-opacity" aria-hidden="true" />
      <div
        ...
        <div class="flex min-h-full items-center justify-center">
          <div class="w-full max-w-3xl p-4 sm:p-6 lg:py-8">
            <.focus_wrap
              ...
              class="shadow-zinc-700/10 ring-zinc-700/10 relative hidden rounded-3xl bg-slate-900 p-14 shadow-lg ring-1 transition"
            >
